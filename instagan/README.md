...
- Train a model:
```
python train.py --dataroot ../datasets/aurora/instagan/train/ --model insta_gan --name cityscapes --loadSizeH 240 --loadSizeW 360 --fineSizeH 200 --fineSizeW 300 --niter 100 --niter_decay 50 
